...
var (
	...
	shellSubstringNamedPattern      = regexp.MustCompile(`\$\{([A-Za-z_][A-Za-z0-9_]*):[0-9]{1,10}(?::[0-9]{1,10})?\}`)
	shellSubstringPosPattern        = regexp.MustCompile(`\$\{([0-9]{1,10}):[0-9]{1,10}(?::[0-9]{1,10})?\}`)
