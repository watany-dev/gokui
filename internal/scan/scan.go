...
var (
	...
	shellSubstringNamedNestedPattern = regexp.MustCompile(`\$\{([A-Za-z_][A-Za-z0-9_]*):\$\{(?:[A-Za-z_][A-Za-z0-9_]*|[0-9]{1,10})\}(?::\$\{(?:[A-Za-z_][A-Za-z0-9_]*|[0-9]{1,10})\})?\}`)
	shellSubstringPosNestedPattern   = regexp.MustCompile(`\$\{([0-9]{1,10}):\$\{(?:[A-Za-z_][A-Za-z0-9_]*|[0-9]{1,10})\}(?::\$\{(?:[A-Za-z_][A-Za-z0-9_]*|[0-9]{1,10})\})?\}`)
