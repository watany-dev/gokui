...
- Lock skill file-path validation hardening with invalid UTF-8 and ASCII control-character rejection for install/update/lock-verify provenance checks
- Lock source-input validation hardening with ASCII control-character rejection for install/update/lock-verify provenance checks
