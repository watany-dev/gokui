...
- URL risk classification for shortener hosts and raw-IP URLs (including scheme-relative `//host/...` forms, bracketed IPv6 hosts, and normalized trailing-dot/IDNA dot-variant hosts)
