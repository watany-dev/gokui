...
- URL risk classification for paste-site URLs and GitHub release asset URLs (including known GitHub CDN hosts, API release-asset forms such as `releases/<release_id>/assets`, object-path forms, and `releases/latest/download` paths)
