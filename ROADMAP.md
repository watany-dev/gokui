...
- release-check gate hardening with isolated build output (`RELEASE_CHECK_BUILD_OUT`), symlink/collision fail-closed build/SARIF output guards, and failure-safe cleanup for build/SARIF artifacts
